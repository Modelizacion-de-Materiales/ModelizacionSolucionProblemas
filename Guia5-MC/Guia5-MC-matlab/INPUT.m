...
[s0,MMEAN0,EMEAN0,E2MEAN0,MABSMEAN0]=ising(5e6, 4,Hext,kT,J);
%[s0,MMEAN0,EMEAN0,E2MEAN0,MABSMEAN0]=ising(1e5, 8,Hext,kT,J);
[s0,MMEAN0,EMEAN0,E2MEAN0,MABSMEAN0]=ising(5e6, 8,Hext,kT,J);
...
[s0,MMEAN0,EMEAN0,E2MEAN0,MABSMEAN0]=ising(1e6, 16,Hext,kT,J);
[s0,MMEAN0,EMEAN0,E2MEAN0,MABSMEAN0]=ising(5e6, 16,Hext,kT,J);
