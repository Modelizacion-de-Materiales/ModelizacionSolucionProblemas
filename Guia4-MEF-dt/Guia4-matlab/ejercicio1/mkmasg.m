% function K = mkmasg(problem,gl,NOD,MC,{modulo1,modulo2, seccion,...})
% Esta función genera la matriz de masa del problema dado, funcionando
% como interfaz de la subrutina 'mkmasa', que genera las matrices locales.
% Aquí se llama a tal subrutina para generar las mismas y luego se las
% ensambla utilizando 'ensamble2'.
%
% problem:
%      = 1 :  masa consistente barra a tracción, deben darse densidad y area 
%      = 2 :  masa concentrada barra a tracción, deben darse densidad y area 
%      = 3 :  masa consistente viga (flección), deben darse densidad y area 
%      = 4 :  masa concentrada viga (fección), deben darse densidad y area 
% gl:  grados de libertad.
% NOD: matriz de nodos
% MC : Matriz de conectividad
% modulos: cualquier otra información física del sistema. Generalmente en
% este orden: rho, E, nu, I, A, ...

function K = mkmasg(problem,gl,NOD,MC,varargin)
