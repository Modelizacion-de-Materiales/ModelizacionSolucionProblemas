...
\hypersetup{pdftitle={ Resumen Guía 0 }}
% Inicia el documento.
\begin{document}
% Título de la clase. 
\mode<presentation>{
...
\input{./Guia0-Ejercicio2}

\input{./Problema-MultimplicarMatrices}

\input{./Problema-AlgebraLineal}

\input{./Problema-splines}

\input{./Problema-Integracion}
